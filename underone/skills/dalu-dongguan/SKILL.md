...
> **世界观**：大罗洞观是"看透万物"的全知法眼，站在大罗天（道家最高天境）俯瞰全局，一眼洞察任何表面看不到的隐藏关联。
> - **置信度 A**（洞若观火）：关联清晰如眼前之物，毋庸置疑
> - **置信度 B**（似有所感）：感知到关联但需核实印证
> - **置信度 C**（一线微光）：隐约感应，待更多证据印证
> - **天眼图卷**（`mermaid_code`）：大罗洞观将看穿的万物关联绘制成可视化图卷
> - **追魂索因**（`cross_segment_trace`）：接收炁体源流的炁归契约后，沿矛盾根源一路追溯
...
>
> **异人语录**（谷畸亭）：
> - 洞观大罗：「大罗洞观，洞见一切」——隐藏关联无所遁形
> - 明察秋毫：「我看到了……那条线」——发现跨段关联
> - 初窥门径：「此间无暗线」——各段独立，无隐藏关联
> - 因果之线：「因果之线，一拉即出」——检测到因果链
